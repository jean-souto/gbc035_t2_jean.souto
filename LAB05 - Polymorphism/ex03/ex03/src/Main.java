     ...
     //   EstudanteDoutorado epd3;
      //  epd3 = (EstudanteDoutorado)epd2;
        ...
        */
        ...
        Universidade Uni = new Universidade("Socorro","13/10/81");

        Uni.newGrad("Jorge", "lala", "plapla");
        Uni.newMestr("Luan", "uaua", "corno", "socor", "doido", "sua");
        Uni.newDout("Sim", "dada", "rsrs", "louco", "sim");
